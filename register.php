        ...
        <div class="login_box">
            ...
            <div id="first">
                <form action="register.php" method="POST">
                    ...
                    <?php if (in_array("Email or passwors was incorrect!", $error_array)) echo "Email or passwors was incorrect!" ?>
                    <br><br>
                    <a href="#" id="signup" class="signup">Nedd an account? Register here!</a>
                </form>
            ...
            <div id="second">
                <form action="register.php" method="POST">
                    ...
                    <br>
                    <?php if (in_array("<span style='color:#14C000'>You're all set! Go ahead and login!</span><br>", $error_array)) echo "<span style='color:#14C000'>You're all set! Go ahead and login!</span><br>" ?>
